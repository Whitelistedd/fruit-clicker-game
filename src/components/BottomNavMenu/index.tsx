  ...
  return (
    <nav className={styles.nav}>
      <ul className={`${styles.list} reset`}>
        <li>
          <Link
            className={`reset ${styles.listItem} ${
              currentUrl.href === getUrlHref("/#").href && styles.listItemActive
            }`}
            to="/"
          >
            <Home />
        ...
        <li>
          <Link
            className={`reset ${styles.listItem} ${
              currentUrl.href === getUrlHref("/#cards").href &&
        ...
        <li>
          <Link
            className={`reset ${styles.listItem} ${
              currentUrl.href === getUrlHref("/#friends").href &&
              styles.listItemActive
            }`}
            to="/friends"
          >
